...
namespace ProjektApp.Core
{
    public class MockAuctionService  /* : IAuctionService*/
    {
        ...
        {
            Auction a1 = new Auction(1, "Auction for orchids", "Very nice orchids",new DateTime(2022, 10, 18, 23,59,59));
            Auction a2 = new Auction(2, "Auction for Mona Lisa", "Pretty old picture of lady with smile", new DateTime(2022, 10, 19));
            Auction a3 = new Auction(3, "Auction for Cats","Very cute cats", new DateTime(2022, 10, 18, 14, 35, 10));
